...
void AInventoryCppCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AInventoryCppCharacter::Look);
	}
	else
	{
...
void AInventoryCppCharacter::PerformInteractionCheck()
{
	...
	float LookDirection = FVector::DotProduct(GetViewRotation().Vector(), GetActorForwardVector());
	if (LookDirection > 0)
	{
...
void AInventoryCppCharacter::BeginInteract()
{
	...
	if (InteractionData.CurrentInteractable)
	{
		if (IsValid(TargetInteractable.GetObject()))
		{
			...
			{
				GetWorldTimerManager().SetTimer(TimerHandle_Interaction, this, &AInventoryCppCharacter::Interact,
