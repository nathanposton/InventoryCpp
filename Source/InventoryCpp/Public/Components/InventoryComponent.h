...
enum class EItemAddResult : uint8
{
	...
	IAR_PartialAmountItemAdded UMETA(
		DisplayName = "Partial amount of items added"),
...
struct FItemAddResult
{
	...
	// Enum representing the end state of the add operation
	UPROPERTY(BlueprintReadOnly, Category = "Item Add Result")
	                                   ...
	                                   const FText& ErrorText)
	{
		...
		AddedPartialResult.OperationResult =
			EItemAddResult::IAR_PartialAmountItemAdded;
...
public:
	...
	UFUNCTION(Category = "Inventory")
	UItemBase* FindMatchingItemByID(UItemBase* ItemIn) const;
	UFUNCTION(Category = "Inventory")
	...
	UFUNCTION(Category = "Inventory")
	FORCEINLINE TArray<UItemBase*> GetInventoryItems() const
	{
...
protected:
	...
	void AddNewItem(UItemBase* ItemIn, const int32 AmountToAdd);
};
